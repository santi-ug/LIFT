...
export const loginUser = async (userData: UserData): Promise<ApiResponse> => {
	try {
		const response = await fetch(`http:172.20.10.6:5000/api/v1/users/login`, {
			method: "POST",
			headers: {
				"Content-Type": "application/json",
			},
...
export const infoUser = async (): Promise<UserData | undefined> => {
	try {
		...
		const response = await fetch(`http:172.20.10.6:5000/api/v1/users/me`, {
			method: "GET",
			headers: {
	...
	try {
		...
		if (imageUri && typeof imageUri === "string") {
			...
			const response = await fetch(
				`http:172.20.10.6:5000/api/v1/users/myImage`,
				{
					method: "PUT",
					body: formData,
					headers: {
...
export const removeImage = async (): Promise<UserData | undefined> => {
	try {
		...
		const response = await fetch(`http:172.20.10.6:5000/api/v1/users/myImage`, {
			method: "DELETE",
			headers: {
				Authorization: `Bearer ${token}`,
			},
...
export const logout = async () => {
	try {
		...
		const response = await fetch(`http:172.20.10.6:5000/api/v1/users/logout`, {
			method: "POST",
			headers: {
				Authorization: `Bearer ${token}`,
				"Content-Type": "application/json",
